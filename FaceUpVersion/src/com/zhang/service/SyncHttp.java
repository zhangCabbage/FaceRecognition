...
public class SyncHttp {
	public static final String host="http://120.24.42.115:8080/face_server";
//	public static final String host="http://www.tyorange.com.cn/notify_server";
	...
	public String httpGet(String url, String params) throws Exception
	{
		...
		try
		{
			...
			Log.i("orange", "statusCode:"+String.valueOf(statusCode));
	...
	public String httpPost(String url, List<Parameter> params) throws Exception
	{
		...
		if (params.size()>=0)
		{
			...
			try {
				...
				int statusCode = httpResponse.getStatusLine().getStatusCode();
				System.out.println( "statusCode:"+String.valueOf(statusCode) );
